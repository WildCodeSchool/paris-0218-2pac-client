...
const LegalNotice = () => {
 ...
 <h2 >Pour une autre PAC</h2>
  ...
  Le site 
  <a href="http://pouruneautrepac.eu/" target="_blank" rel="noopener noreferrer">pouruneautrepac.eu</a>
  ...
  <a href="http://pouruneautrepac.eu/" target="_blank" rel="noopener noreferrer">
    pouruneautrepac.eu
  </a> est hébergé par la SAS OVH. Pour plus d'informations, reportez-vous au site: 
  ...
  <br />
  Pour une demande de ce type, veuillez adresser un courrier à Pour une autre PAC ou contacter l'adresse <br /> courriel : aurelie.catallo@pouruneautrepac.eu
  .
  <br />
  <br />
  <h2>Cookies</h2>
