...
const BilanActuel = ({children}) => {
  ...
  <span class="s1">
    ...
    <em>
     ...
     revient, enjeu par enjeu, sur les forces et les lacunes de la PAC actuelle.
  </span>
</p>
<p class="p2">
   
...
<p class="p3">
  <span class="s1">
    <strong>
      Des aides au développement rural louables, mais ne faisant pas le poids face au 1
    </strong>
  </span>
  <span class="s2">
    <strong>
...
<p class="p7">
  <span class="s1">
    Bilan de l’actuelle PAC de la plateforme <i>Pour une autre PAC </i> à télécharger
  </span>
</p>
<p class="p8">
   
