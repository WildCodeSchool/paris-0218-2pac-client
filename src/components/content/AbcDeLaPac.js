  ...
  return (
    <div className="container-content">
      ...
      <ul>
        ...
        <li>Le deuxième pilier porte sur le développement rural. Il a la particularité d’être co-financé par de l’argent européen et de l’argent national (venant de l’États, des collectivités       territoriales, ou encore des agences de l’eau). Il apporte un soutien complémentaire aux agriculteur·rice·s en situation de désavantage compétitif du fait de la zone géographique dans laquelle      ils ou elles sont situé·e·s e, de leurs pratiques ou du démarrage de leur activité. Il accompagne aussi l’évolution des fermes vers plus de compétitivité ou une meilleure prise en compte de     l’environnement.</li>
      ...
      <ul>
        <li><a href="https://www.supagro.fr/capeye/histoire-de-la-pac/">https://www.supagro.fr/capeye/histoire-de-la-pac/</a></li>
