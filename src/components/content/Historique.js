...
const Historique = ({children}) => {
  return (
    <div className="container-content">
      ...
      <ul>
        <li>Réaction au bilan de santé de la PAC (25 février 2008)</li>
        <li>Constats, propositions et leviers d'action pour une politique agricole, alimentaire, environnementale et rurale européenne (18 février 2010)</li>
        <li>Propositions pour rémunérer les services environnementaux et socio-territoriaux associés à l'agriculture en ciblant les paiements directs pour relégitimer la PAC (7 septembre 2010)</li>
        <li>Commentaire de la communication de la Commission européenne du 18 novembre 2010 intitulée « La PAC à l’horizon 2020 : alimentation, ressources naturelles et territoire – relever les défis de l’avenir » (6 juin 2011)</li>
        <li>Analyse des propositions de la Commission européenne pour la réforme de la PAC (27 février 2012)</li>
