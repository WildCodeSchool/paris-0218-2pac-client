    ...
    <div>
      <Container>
        ...
        <ul className="circle-list">
          ...
          <li><BulletedList /> Promouvoir une réforme ambitieuse de la PAC et orienter sa définition vers plus de durabilité, de justice et de cohérence :
            <ul>
          ...
          <li><BulletedList /> Sensibiliser et mobiliser la société civile autour des enjeux liés à la politique agricole :
            <ul>
